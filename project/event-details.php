...
$stmtEvent = $db->prepare("SELECT * FROM events WHERE slug = ?");
...
================================= -->
<?php $bgUrl = !empty($event['hero_banner_url']) ? "background-image: url('" . str_replace("'", "\\'", $event['hero_banner_url']) . "') !important;" : ""; ?>
