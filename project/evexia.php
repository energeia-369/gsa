<?php
$pageTitle = "EVEXIA - Wellness, Healthcare & Lifestyle";
...
<div class="pillar-page evexia-page">
  <div class="pillar-hero">
    <h1>EVEXIA</h1>
    <p class="subtitle">Wellness, Healthcare & Lifestyle</p>
  </div>
  ...
  <section class="pillar-section">
    ...
    <p style="color:#7A7061; line-height: 1.6; font-size: 1.1rem;">
      Evexia focuses on elevating the human experience by merging wellness, modern healthcare, and premium lifestyle services. We aim to redefine personal well-being through holistic experiences, cutting-edge medical tourism, and luxurious hospitality.
    </p>
  </section>
  ...
  <div class="pillar-grid" style="margin-bottom: 40px;">
    <section class="pillar-section" style="margin-bottom: 0;">
      ...
      <p style="color:#7A7061; line-height: 1.6;">
        To enhance the quality of life globally by integrating advanced healthcare solutions with premium wellness and hospitality experiences.
      </p>
    </section>
    ...
    <section class="pillar-section" style="margin-bottom: 0;">
      <h2>Vision</h2>
      <p style="color:#7A7061; line-height: 1.6;">
        A global society where holistic health and wellness are seamlessly integrated into everyday life and lifestyle choices.
      </p>
    </section>
  </div>
    ...
    <div class="pillar-grid">
      <div class="pillar-card-box">
        ...
        <ul style="color:#7A7061; line-height:1.8; margin-left: 20px;">
          <li>Medical Tourism & Healthcare</li>
          <li>Holistic Wellness Retreats</li>
          <li>Luxury Hospitality & Spa</li>
      ...
      <div class="pillar-card-box">
        ...
        <ul style="color:#7A7061; line-height:1.8; margin-left: 20px;">
          <li>Healthcare Professionals & Experts</li>
          <li>Wellness Brand Founders</li>
          <li>Hospitality Industry Leaders</li>
          <li>Health-Tech Innovators</li>
        </ul>
      </div>
    </div>
  </section>
  ...
  <section class="pillar-section">
    ...
    <p style="color:#9aa0b4; line-height: 1.6; margin-bottom: 20px;">
      Engage in immersive wellness retreats, try out the latest health-tracking wearables in interactive zones, and attend seminars by world-renowned mental and physical health experts.
    </p>
  </section>
